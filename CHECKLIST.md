...
testów: **2656 testów, `flutter analyze` czysty, schemat bazy v37**.
...
| :---- | ----: | :---- |
| `ui` | 476 | HUD, ekwipunek, panele, arkusze, geometria dotknięć i pierścieni, notatki stanu, dziennik, niebo w panelu, zakres przebudów |
| `combat` | 489 | tabela kalibracyjna §5.1.2 wiersz po wierszu, obrażenia §5.1.5, budżet sprintu, maszyna stanów, hałas, spawn, magazynek, dodatki, **odczyt panelu ognia**, **ciosy przy zgaszonym ekranie**, **pole widzenia, słuch i cios w plecy (§6.2, §5.5.1)**, Strefy Rozkładu: punktacja, wzrost, wysyp, kronika, **dwa kanały obrażeń i zasięg broni (§5.5.3)** |
| `sim` | 346 | tick, metabolizm, tętno, wchłanianie, **dwa zegary snu**, **masa ciała i wychudzenie**, **osiągalność zgonu z głodu i pragnienia**, **kary za stan docierające do zegarów**, **nawyk gry mierzony, nie zakładany (§16.4)**, świt i zmierzch, **drabinka kar generowana z modelu (§2.3, §2.5.4)** |
