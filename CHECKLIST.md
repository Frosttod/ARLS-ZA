...
testów: **2577 testów, `flutter analyze` czysty, schemat bazy v36**.
...
| :---- | ----: | :---- |
| `ui` | 466 | HUD, ekwipunek, panele, arkusze, geometria dotknięć i pierścieni, notatki stanu, dziennik, niebo w panelu, zakres przebudów |
