...
class Hotspots extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> surgedAt = GeneratedColumn<String>(
    'surged_at',
    aliasedName,
    true,
    type: DriftSqlType.string,
...
class Journal extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class ReadTitles extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ReadTitles(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> profileId = GeneratedColumn<int>(
    'profile_id',
    aliasedName,
    false,
  ...
  @override
  ReadTitles createAlias(String alias) {
    return ReadTitles(attachedDatabase, alias);
  }
...
class PlayDays extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PlayDays(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> profileId = GeneratedColumn<int>(
    'profile_id',
    aliasedName,
    false,
  ...
  @override
  PlayDays createAlias(String alias) {
    return PlayDays(attachedDatabase, alias);
  }
...
class DatabaseAtV37 extends GeneratedDatabase {
  ...
  late final ReadTitles readTitles = ReadTitles(this);
  late final PlayDays playDays = PlayDays(this);
  @override
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('journal', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'profiles',
      ...
      result: [TableUpdate('read_titles', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'profiles',
      ...
      result: [TableUpdate('play_days', kind: UpdateKind.delete)],
    ),
  ]);
  @override
